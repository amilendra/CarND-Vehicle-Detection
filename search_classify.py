...
# {'cell_per_block': 2, 'orient': 9, 'spatial_size': (32, 32), 'scaler': StandardScaler(copy=True, with_mean=True, with_std=True), 'pix_per_cell': 8, 'hist_bins': 32, 'svc': LinearSVC(C=1.0, class_weight=None, dual=True, fit_intercept=True, intercept_scaling=1, loss='squared_hinge', max_iter=1000, multi_class='ovr', penalty='l2', random_state=None, tol=0.0001, verbose=0)} 
